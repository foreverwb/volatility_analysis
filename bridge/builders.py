...
def build_bridge_snapshot(rec: Dict[str, Any], cfg: Dict[str, Any]) -> BridgeSnapshot:
    ...
    execution_state = {
        ...
        "permission_reasons": rec.get("permission_reasons"),
        "disabled_structures": rec.get("disabled_structures"),
        "watch_triggers": rec.get("watch_triggers"),
        "what_to_monitor": rec.get("what_to_monitor"),
        "posture_5d": rec.get("posture_5d"),
        "posture_reasons": rec.get("posture_reasons"),
        "posture_reason_codes": rec.get("posture_reason_codes"),
